                    ...
                    <div class="widget__content card__content" id="data" data-id="<?= BASEURL ?>">
                        <div class="widget-tabbed__tabs">
                            ...
                            <ul class="nav nav-tabs nav-justified widget-tabbed__nav" role="tablist">
                                <li class="nav-item"><a href="#personalinformation" class="nav-link active" aria-controls="personalinformation" role="tab" data-toggle="tab" aria-selected="true">PERSONAL INFORMATION</a></li>
                                <li class="nav-item"><a href="#mygame" class="nav-link" aria-controls="mygame" role="tab" data-toggle="tab" aria-selected="false">MY GAME</a></li>
                            </ul>
