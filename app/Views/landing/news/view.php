                        ...
                        <div class="posts__item posts__item--card posts__item--category-1 posts__item--category-4  card">
                            ...
                            <div class="posts__inner card__content">
                                ...
                                <h6 class="posts__title posts__title--color-hover">
                                    ...
                                    <a href="<?=url('news/'.$row['url']);?>" class="berita" data-id="<?= $row['id_news_game'] ?>"><?= strtoupper(substr($row['judul'],0,40).'....'); ?></a>
                                    <?php else:?>
                                    <a href="<?=url('news/'.$row['url']);?>" class="berita" data-id="<?= $row['id_news_game'] ?>"><?= strtoupper($row['judul']); ?></a>
                                    <?php endif;?>
                                </h6>
